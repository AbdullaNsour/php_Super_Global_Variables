document.getElementById('sub_nsour') = function () { Registervalidate }
function Registervalidate() {
    ...
    if (emailField.value == null || emailField.value == "") {
        document.getElementById("email-error").textContent = "The email field is required.";
    }


    if (inputFirstName.value == '') {
        document.getElementById("fname-error").textContent ="The first name field is required.";
        return false;
    } else {
        document.getElementById("fname-error").textContent = "";
    }
    if (inputMiddleName.value == '') {
        document.getElementById("m-name-error").textContent = "The first name field is required.";
        return false;
    } else {
